...
/* MT6582: misma disposición que mt2701 (EN=BIT16, con0=0xa8, con1=0xac) PERO con
 * bls_debug=0 -> NO escribe DISP_PWM_DEBUG (0xb0). El OEM nunca lo toca; escribirlo
 * descuadra el color/backlight latcheado. Sin él los escritos van directos. */
static const struct mtk_pwm_data mt6582_pwm_data = {
	.enable_mask = BIT(16),
	.con0 = 0xa8,
	.con0_sel = 0x2,
	.con1 = 0xac,
...
static const struct of_device_id mtk_disp_pwm_of_match[] = {
	...
	{ .compatible = "mediatek,mt6582-disp-pwm", .data = &mt6582_pwm_data},
