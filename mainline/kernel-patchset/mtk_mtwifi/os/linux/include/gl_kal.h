...
/* 7.0.12 port: struct wake_lock removed from mainline. Wake locks are
...
/*----------------------------------------------------------------------------*/
/* 7.0.12 port: wake_lock_*() API removed from mainline; make all wake-lock
