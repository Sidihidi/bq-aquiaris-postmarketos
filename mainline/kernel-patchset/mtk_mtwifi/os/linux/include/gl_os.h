...
/* 7.0.12 port: <linux/wakelock.h> was removed from mainline. Wake locks are
...
/* 7.0.12 port: MediaTek AEE (aee.h) is not available on mainline; guarded
