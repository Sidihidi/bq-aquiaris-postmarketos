...
/* ===== shims del port STA-only a 7.0.12 (MTK WMT/MCU-debug dieted) ===== */
#ifndef _PORT_STA_DEBUG_SHIMS
#define _PORT_STA_DEBUG_SHIMS
#ifndef ASSERT_BREAK
#define ASSERT_BREAK(_exp) { if (!(_exp)) { ASSERT(FALSE); break; } }
#endif
#ifndef MCU_REG_READL
#define MCU_REG_READL(_hif, _reg)  (0u)
#endif
#ifndef CONN_MCU_CPUPCR
#define CONN_MCU_CPUPCR  (0)
#endif
#ifndef WMTDRV_TYPE_WIFI
#define WMTDRV_TYPE_WIFI  (0)
#endif
static inline void mtk_wcn_wmt_assert(int type, int reason) { (void)type; (void)reason; }
static inline void glDumpConnSysCpuInfo(void *prGlueInfo) { (void)prGlueInfo; }
#endif /* _PORT_STA_DEBUG_SHIMS */
